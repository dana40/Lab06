...
1.  What are the dimensions of the Denny's dataset?
    ...
    What are the variables? 3 variables
...
2.  What are the dimensions of the La Quinta's dataset? 1
    What does each row in the dataset represent? 909
    What are the variables? 6
...
4.  Which states have the most and fewest Denny's locations? CA. What about La Quinta? Is this surprising? Why or why not?
...
5. Which states have the most Denny's locations per thousand square miles? United States. What about La Quinta?
